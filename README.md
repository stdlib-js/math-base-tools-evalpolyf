...
```javascript
import evalpolyf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-tools-evalpolyf@v0.1.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-tools-evalpolyf/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/math-base-tools-evalpolyf/actions/workflows/test.yml?query=branch:v0.1.2
